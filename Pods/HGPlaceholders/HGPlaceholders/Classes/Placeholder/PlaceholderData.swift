...
public struct PlaceholderData {
    ...
    public static var loading: PlaceholderData {
        ...
        loadingStyle.title = NSLocalizedString("Cargando Información", comment: "")
      
        loadingStyle.subtitle = NSLocalizedString("Espere un momento por favor", comment: "")
    ...
    public static var error: PlaceholderData {
        ...
        errorStyle.subtitle = NSLocalizedString("Creo que existe un error al cargar la información", comment: "")
        return errorStyle
    }
